      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a href="Insertar.php">Dar de Alta </a>
            <ul>
                <li  class="active"><a href="InsertarDocente.php">Registrar docentes</a></li>
...
<section id="intro" class="clearfix">
    <div class="row justify-content-center align-self-center">
        ...
        <p><h2  align="center">Registro de Docentes</h2><br /></p>
        ...
        <table align="center" width=100%>
            ...
            <br/>
            <p align="center">
            Carrera Principal donde enseñara<br/>
             <select name="jefe">
                <option value="2010480150189">Ing. Animacion digital y efectos visuales</option>
                <option value="2010480150903">Ing. Sistemas Computacionales</option>
                <option value="2010480150188">Ing. Mecatronica </option>
                <option value="2010480150200">Ing. Electromecanica </option>
                <option value="2010480150887">Ing. Industrial</option>
                <option value="2010480150123">Ing. Quimica </option>
                <option value="2010480150567">Ing. Materiales</option>
                <option value="2010480150098">Ing. gestion empresarial</option>
                <option value="2010480150134">Lic. Contaduria</option>
                <option value="2010480150209">Lic. Arquitectura </option>
                <option value="2010480150201">Lic. Turismo </option>
                
                </select>
                <br /> <br /> <br /> <br />
                <input type="submit" name="boton" value="Registrar Docente" weidth=30%>
                </p>
        </form>
