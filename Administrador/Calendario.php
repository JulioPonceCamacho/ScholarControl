  ...
  <section id="intro" class="clearfix">
    <div class="row justify-content-center align-self-center">
        <div class="col-md-6 intro-info order-md-first order-last">
          ...
          <p><h2  align="center">Calendario Escolar Ciclo 2020-2021</h2></p> 
          <img src="../Imagenes/Calendario.jpg" width=100%>
    </div>
    </div>
  </section>
      ...
      <div class="container">
        ...
        <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-duration="1.4s">
            <div class="box">
              ...
              <p class="description">Consultar calendario escolar del periodo actual.</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-duration="1.4s">
            <div class="box">
              <div class="icon" style="background: #fff0da;"><i class="ion-ios-bookmarks-outline" style="color: #e98e06;"></i></div>
              <h4 class="title"><a href="Eventos.php">Eventos y actividades</a></h4>
              <p class="description">COnsultar los eventos y actividaes proximas.</p>
            </div>
          </div>
